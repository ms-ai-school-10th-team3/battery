...
RESULT_DIR = BASE_DIR / "results" / f"{DATA_TYPE}_defect_type_resnet18"
...
plt.ylabel("Loss")
plt.legend()
plt.title(f"{DATA_TYPE} Defect Type Loss - ResNet18")
...
plt.ylabel("Accuracy")
plt.legend()
plt.title(f"{DATA_TYPE} Defect Type Accuracy - ResNet18")
...
model_save_path = MODEL_DIR / f"{DATA_TYPE}_defect_type_resnet18.pth"
